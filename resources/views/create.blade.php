    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('addressbook') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="address_from_1" type="text" class="form-control{{ $errors->has('address_from_1') ? ' is-invalid' : '' }}" name="address_from_1" value="{{ old('address_from_1') }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="address_from_2" type="text" class="form-control{{ $errors->has('address_from_2') ? ' is-invalid' : '' }}" name="address_from_2" value="{{ old('address_from_2') }}" required>
                        ...
                        <div class="form-group row">
                            <label for="address_from_1" class="col-sm-4 col-form-label text-md-right"></label>
                            <div class="col-md-6">
                                <input id="address_from_3" type="text" class="form-control{{ $errors->has('address_from_3') ? ' is-invalid' : '' }}" name="address_from_3" value="{{ old('address_from_3') }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="address_to_1" type="text" class="form-control{{ $errors->has('address_to_1') ? ' is-invalid' : '' }}" name="address_to_1" value="{{ old('address_to_1') }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="address_to_2" type="text" class="form-control{{ $errors->has('address_to_2') ? ' is-invalid' : '' }}" name="address_to_2" value="{{ old('address_to_2') }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="address_to_3" type="text" class="form-control{{ $errors->has('address_to_3') ? ' is-invalid' : '' }}" name="address_to_3" value="{{ old('address_to_3') }}" required>
